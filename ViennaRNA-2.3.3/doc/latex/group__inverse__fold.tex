...
when to stop \hyperlink{group__inverse__fold_gaeef52ecbf2a2450ad585a344f9826806}{inverse\+\_\+pf\+\_\+fold()} \index{Inverse Folding (\+Design)@{Inverse Folding (\+Design)}!give\+\_\+up@{give\+\_\+up}}
...
default 0\+: try to minimize structure distance even if no exact solution can be found \index{Inverse Folding (\+Design)@{Inverse Folding (\+Design)}!inv\+\_\+verbose@{inv\+\_\+verbose}}
