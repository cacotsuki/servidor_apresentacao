\hypertarget{group__subopt__stochbt}{}\section{Structure sampling from the ensemble}
\label{group__subopt__stochbt}\index{Structure sampling from the ensemble@{Structure sampling from the ensemble}}
...
\index{Structure sampling from the ensemble@{Structure sampling from the ensemble}!vrna\+\_\+pbacktrack5@{vrna\+\_\+pbacktrack5}}
\index{vrna\+\_\+pbacktrack5@{vrna\+\_\+pbacktrack5}!Structure sampling from the ensemble@{Structure sampling from the ensemble}}
...
\end{DoxyReturn}
\index{Structure sampling from the ensemble@{Structure sampling from the ensemble}!vrna\+\_\+pbacktrack@{vrna\+\_\+pbacktrack}}
\index{vrna\+\_\+pbacktrack@{vrna\+\_\+pbacktrack}!Structure sampling from the ensemble@{Structure sampling from the ensemble}}
...
A sampled secondary structure in dot-\/bracket notation 
\end{DoxyReturn}
\index{Structure sampling from the ensemble@{Structure sampling from the ensemble}!pbacktrack@{pbacktrack}}
\index{pbacktrack@{pbacktrack}!Structure sampling from the ensemble@{Structure sampling from the ensemble}}
...
A sampled secondary structure in dot-\/bracket notation 
\end{DoxyReturn}
\index{Structure sampling from the ensemble@{Structure sampling from the ensemble}!pbacktrack\+\_\+circ@{pbacktrack\+\_\+circ}}
\index{pbacktrack\+\_\+circ@{pbacktrack\+\_\+circ}!Structure sampling from the ensemble@{Structure sampling from the ensemble}}
...
\index{Structure sampling from the ensemble@{Structure sampling from the ensemble}!st\+\_\+back@{st\+\_\+back}}
\index{st\+\_\+back@{st\+\_\+back}!Structure sampling from the ensemble@{Structure sampling from the ensemble}}
