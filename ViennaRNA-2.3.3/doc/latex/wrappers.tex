...
\item[\label{wrappers__wrappers000011}%
...
\end{DoxyCode}
 In both variants, the {\ttfamily options} argument is optional can may be omitted.  
\item[\label{wrappers__wrappers000013}%
...
\item[\label{wrappers__wrappers000014}%
...
\item[\label{wrappers__wrappers000015}%
...
Global \hyperlink{group__domains__up_gaec0c3313fb2951946614f920d289829a}{vrna\+\_\+ud\+\_\+add\+\_\+motif} (vrna\+\_\+fold\+\_\+compound\+\_\+t $\ast$vc, const char $\ast$motif, double motif\+\_\+en, unsigned int loop\+\_\+type)]This function is attached as method {\bfseries ud\+\_\+add\+\_\+motif()} to objects of type {\itshape fold\+\_\+compound}  
