...
*print_stren = *RNAc::print_stren;
*print_str = *RNAc::print_str;
*copy_arr = *RNAc::copy_arr;
*allocopy = *RNAc::allocopy;
*move_gradient = *RNAc::move_gradient;
*move_first = *RNAc::move_first;
*move_adaptive = *RNAc::move_adaptive;
*browse_neighs_pt = *RNAc::browse_neighs_pt;
*browse_neighs = *RNAc::browse_neighs;
...
*E_ext_loop = *RNAc::E_ext_loop;
*E_ext_loop_5 = *RNAc::E_ext_loop_5;
...
*E_mb_loop_stack = *RNAc::E_mb_loop_stack;
...
*swig_canonicalBPonly_get = *RNAc::md_canonicalBPonly_get;
*swig_canonicalBPonly_set = *RNAc::md_canonicalBPonly_set;
...
############# Class : RNA::PlistVector ##############

package RNA::PlistVector;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( RNA );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = RNAc::new_PlistVector(@_);
    bless $self, $pkg if defined($self);
}

*size = *RNAc::PlistVector_size;
*empty = *RNAc::PlistVector_empty;
*clear = *RNAc::PlistVector_clear;
*push = *RNAc::PlistVector_push;
*pop = *RNAc::PlistVector_pop;
*get = *RNAc::PlistVector_get;
*set = *RNAc::PlistVector_set;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
%OWNER = ();
%ITERATORS = ();
*swig_type_get = *RNAc::cmd_type_get;
*swig_type_set = *RNAc::cmd_type_set;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
sub new {
    my $pkg = shift;
    my $self = RNAc::new_CmdVector(@_);
    bless $self, $pkg if defined($self);
}

*size = *RNAc::CmdVector_size;
*empty = *RNAc::CmdVector_empty;
*clear = *RNAc::CmdVector_clear;
*push = *RNAc::CmdVector_push;
*pop = *RNAc::CmdVector_pop;
*get = *RNAc::CmdVector_get;
*set = *RNAc::CmdVector_set;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*swig_end_get = *RNAc::duplexT_end_get;
*swig_end_set = *RNAc::duplexT_end_set;
...
*swig_energy_backtrack_get = *RNAc::duplexT_energy_backtrack_get;
*swig_energy_backtrack_set = *RNAc::duplexT_energy_backtrack_set;
*swig_opening_backtrack_x_get = *RNAc::duplexT_opening_backtrack_x_get;
*swig_opening_backtrack_x_set = *RNAc::duplexT_opening_backtrack_x_set;
*swig_opening_backtrack_y_get = *RNAc::duplexT_opening_backtrack_y_get;
*swig_opening_backtrack_y_set = *RNAc::duplexT_opening_backtrack_y_set;
*swig_offset_get = *RNAc::duplexT_offset_get;
*swig_offset_set = *RNAc::duplexT_offset_set;
*swig_dG1_get = *RNAc::duplexT_dG1_get;
*swig_dG1_set = *RNAc::duplexT_dG1_set;
*swig_dG2_get = *RNAc::duplexT_dG2_get;
*swig_dG2_set = *RNAc::duplexT_dG2_set;
*swig_ddG_get = *RNAc::duplexT_ddG_get;
*swig_ddG_set = *RNAc::duplexT_ddG_set;
*swig_tb_get = *RNAc::duplexT_tb_get;
*swig_tb_set = *RNAc::duplexT_tb_set;
*swig_te_get = *RNAc::duplexT_te_get;
*swig_te_set = *RNAc::duplexT_te_set;
*swig_qb_get = *RNAc::duplexT_qb_get;
*swig_qb_set = *RNAc::duplexT_qb_set;
*swig_qe_get = *RNAc::duplexT_qe_get;
*swig_qe_set = *RNAc::duplexT_qe_set;
sub new {
    my $pkg = shift;
...
%OWNER = ();
%ITERATORS = ();
*swig_k_get = *RNAc::folden_k_get;
*swig_k_set = *RNAc::folden_k_set;
*swig_energy_get = *RNAc::folden_energy_get;
*swig_energy_set = *RNAc::folden_energy_set;
*swig_next_get = *RNAc::folden_next_get;
*swig_next_set = *RNAc::folden_next_set;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
sub CMD_ERROR () { $RNAc::CMD_ERROR }
sub CMD_LAST () { $RNAc::CMD_LAST }
sub CMD_HC () { $RNAc::CMD_HC }
sub CMD_SC () { $RNAc::CMD_SC }
sub CMD_MOTIF () { $RNAc::CMD_MOTIF }
sub CMD_UD () { $RNAc::CMD_UD }
sub CMD_SD () { $RNAc::CMD_SD }
