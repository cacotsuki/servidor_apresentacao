...
def file_msa_detect_format(filename, options):
...
class fold_compound(object):
    ...
    def eval_structure_verbose(self, structure, file):
        return _RNA.fold_compound_eval_structure_verbose(self, structure, file)

    def eval_structure_pt_verbose(self, pt, file):
