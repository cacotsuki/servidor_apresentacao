...
class md(object):
    ...
    canonicalBPonly = _swig_property(_RNA.md_canonicalBPonly_get, _RNA.md_canonicalBPonly_set)
...
class PlistVector(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def iterator(self) -> "swig::SwigPyIterator *":
        return _RNA.PlistVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self) -> "bool":
        return _RNA.PlistVector___nonzero__(self)

    def __bool__(self) -> "bool":
        return _RNA.PlistVector___bool__(self)

    def __len__(self) -> "std::vector< vrna_plist_t >::size_type":
        return _RNA.PlistVector___len__(self)

    def __getslice__(self, i: 'std::vector< vrna_plist_t >::difference_type', j: 'std::vector< vrna_plist_t >::difference_type') -> "std::vector< vrna_plist_t,std::allocator< vrna_plist_t > > *":
        return _RNA.PlistVector___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _RNA.PlistVector___setslice__(self, *args)

    def __delslice__(self, i: 'std::vector< vrna_plist_t >::difference_type', j: 'std::vector< vrna_plist_t >::difference_type') -> "void":
        return _RNA.PlistVector___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _RNA.PlistVector___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< vrna_plist_t >::value_type const &":
        return _RNA.PlistVector___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        return _RNA.PlistVector___setitem__(self, *args)

    def pop(self) -> "std::vector< vrna_plist_t >::value_type":
        return _RNA.PlistVector_pop(self)

    def append(self, x: 'std::vector< vrna_plist_t >::value_type const &') -> "void":
        return _RNA.PlistVector_append(self, x)

    def empty(self) -> "bool":
        return _RNA.PlistVector_empty(self)

    def size(self) -> "std::vector< vrna_plist_t >::size_type":
        return _RNA.PlistVector_size(self)

    def swap(self, v: 'PlistVector') -> "void":
        return _RNA.PlistVector_swap(self, v)

    def begin(self) -> "std::vector< vrna_plist_t >::iterator":
        return _RNA.PlistVector_begin(self)

    def end(self) -> "std::vector< vrna_plist_t >::iterator":
        return _RNA.PlistVector_end(self)

    def rbegin(self) -> "std::vector< vrna_plist_t >::reverse_iterator":
        return _RNA.PlistVector_rbegin(self)

    def rend(self) -> "std::vector< vrna_plist_t >::reverse_iterator":
        return _RNA.PlistVector_rend(self)

    def clear(self) -> "void":
        return _RNA.PlistVector_clear(self)

    def get_allocator(self) -> "std::vector< vrna_plist_t >::allocator_type":
        return _RNA.PlistVector_get_allocator(self)

    def pop_back(self) -> "void":
        return _RNA.PlistVector_pop_back(self)

    def erase(self, *args) -> "std::vector< vrna_plist_t >::iterator":
        return _RNA.PlistVector_erase(self, *args)

    def __init__(self, *args):
        this = _RNA.new_PlistVector(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this

    def push_back(self, x: 'std::vector< vrna_plist_t >::value_type const &') -> "void":
        return _RNA.PlistVector_push_back(self, x)

    def front(self) -> "std::vector< vrna_plist_t >::value_type const &":
        return _RNA.PlistVector_front(self)

    def back(self) -> "std::vector< vrna_plist_t >::value_type const &":
        return _RNA.PlistVector_back(self)

    def assign(self, n: 'std::vector< vrna_plist_t >::size_type', x: 'std::vector< vrna_plist_t >::value_type const &') -> "void":
        return _RNA.PlistVector_assign(self, n, x)

    def resize(self, *args) -> "void":
        return _RNA.PlistVector_resize(self, *args)

    def insert(self, *args) -> "void":
        return _RNA.PlistVector_insert(self, *args)

    def reserve(self, n: 'std::vector< vrna_plist_t >::size_type') -> "void":
        return _RNA.PlistVector_reserve(self, n)

    def capacity(self) -> "std::vector< vrna_plist_t >::size_type":
        return _RNA.PlistVector_capacity(self)
    __swig_destroy__ = _RNA.delete_PlistVector
    __del__ = lambda self: None
PlistVector_swigregister = _RNA.PlistVector_swigregister
PlistVector_swigregister(PlistVector)
cvar = _RNA.cvar


def plist(structure: 'std::string', pr: 'float') -> "std::vector< vrna_plist_t,std::allocator< vrna_plist_t > >":
    return _RNA.plist(structure, pr)
plist = _RNA.plist

_RNA.PLIST_TYPE_BASEPAIR_swigconstant(_RNA)
PLIST_TYPE_BASEPAIR = _RNA.PLIST_TYPE_BASEPAIR

_RNA.PLIST_TYPE_GQUAD_swigconstant(_RNA)
PLIST_TYPE_GQUAD = _RNA.PLIST_TYPE_GQUAD

_RNA.PLIST_TYPE_H_MOTIF_swigconstant(_RNA)
PLIST_TYPE_H_MOTIF = _RNA.PLIST_TYPE_H_MOTIF

_RNA.PLIST_TYPE_I_MOTIF_swigconstant(_RNA)
PLIST_TYPE_I_MOTIF = _RNA.PLIST_TYPE_I_MOTIF

_RNA.PLIST_TYPE_UD_MOTIF_swigconstant(_RNA)
...
def E_ext_loop_5(vc: 'fold_compound') -> "void":
    return _RNA.E_ext_loop_5(vc)
E_ext_loop_5 = _RNA.E_ext_loop_5
...
def E_mb_loop_stack(i: 'int', j: 'int', vc: 'fold_compound') -> "int":
    return _RNA.E_mb_loop_stack(i, j, vc)
E_mb_loop_stack = _RNA.E_mb_loop_stack
...
_RNA.FILE_FORMAT_MSA_CLUSTAL_swigconstant(_RNA)
FILE_FORMAT_MSA_CLUSTAL = _RNA.FILE_FORMAT_MSA_CLUSTAL

_RNA.FILE_FORMAT_MSA_DEFAULT_swigconstant(_RNA)
FILE_FORMAT_MSA_DEFAULT = _RNA.FILE_FORMAT_MSA_DEFAULT

_RNA.FILE_FORMAT_MSA_FASTA_swigconstant(_RNA)
FILE_FORMAT_MSA_FASTA = _RNA.FILE_FORMAT_MSA_FASTA

_RNA.FILE_FORMAT_MSA_MAF_swigconstant(_RNA)
FILE_FORMAT_MSA_MAF = _RNA.FILE_FORMAT_MSA_MAF

_RNA.FILE_FORMAT_MSA_NOCHECK_swigconstant(_RNA)
FILE_FORMAT_MSA_NOCHECK = _RNA.FILE_FORMAT_MSA_NOCHECK

_RNA.FILE_FORMAT_MSA_STOCKHOLM_swigconstant(_RNA)
FILE_FORMAT_MSA_STOCKHOLM = _RNA.FILE_FORMAT_MSA_STOCKHOLM

_RNA.FILE_FORMAT_MSA_UNKNOWN_swigconstant(_RNA)
FILE_FORMAT_MSA_UNKNOWN = _RNA.FILE_FORMAT_MSA_UNKNOWN

def file_msa_detect_format(filename: 'char const *', options: 'unsigned int') -> "unsigned int":
    return _RNA.file_msa_detect_format(filename, options)
file_msa_detect_format = _RNA.file_msa_detect_format

_RNA.UNSTRUCTURED_DOMAIN_EXT_LOOP_swigconstant(_RNA)
UNSTRUCTURED_DOMAIN_EXT_LOOP = _RNA.UNSTRUCTURED_DOMAIN_EXT_LOOP

_RNA.UNSTRUCTURED_DOMAIN_HP_LOOP_swigconstant(_RNA)
UNSTRUCTURED_DOMAIN_HP_LOOP = _RNA.UNSTRUCTURED_DOMAIN_HP_LOOP

_RNA.UNSTRUCTURED_DOMAIN_INT_LOOP_swigconstant(_RNA)
UNSTRUCTURED_DOMAIN_INT_LOOP = _RNA.UNSTRUCTURED_DOMAIN_INT_LOOP

_RNA.UNSTRUCTURED_DOMAIN_MB_LOOP_swigconstant(_RNA)
UNSTRUCTURED_DOMAIN_MB_LOOP = _RNA.UNSTRUCTURED_DOMAIN_MB_LOOP

_RNA.UNSTRUCTURED_DOMAIN_ALL_LOOPS_swigconstant(_RNA)
UNSTRUCTURED_DOMAIN_ALL_LOOPS = _RNA.UNSTRUCTURED_DOMAIN_ALL_LOOPS

_RNA.UNSTRUCTURED_DOMAIN_MOTIF_swigconstant(_RNA)
UNSTRUCTURED_DOMAIN_MOTIF = _RNA.UNSTRUCTURED_DOMAIN_MOTIF

_RNA.CMD_ERROR_swigconstant(_RNA)
CMD_ERROR = _RNA.CMD_ERROR

_RNA.CMD_LAST_swigconstant(_RNA)
CMD_LAST = _RNA.CMD_LAST

_RNA.CMD_HC_swigconstant(_RNA)
CMD_HC = _RNA.CMD_HC

_RNA.CMD_SC_swigconstant(_RNA)
CMD_SC = _RNA.CMD_SC

_RNA.CMD_MOTIF_swigconstant(_RNA)
CMD_MOTIF = _RNA.CMD_MOTIF

_RNA.CMD_UD_swigconstant(_RNA)
CMD_UD = _RNA.CMD_UD

_RNA.CMD_SD_swigconstant(_RNA)
CMD_SD = _RNA.CMD_SD
class cmd(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
...
_RNA.CMD_PARSE_DEFAULTS_swigconstant(_RNA)
CMD_PARSE_DEFAULTS = _RNA.CMD_PARSE_DEFAULTS

_RNA.CMD_PARSE_HC_swigconstant(_RNA)
CMD_PARSE_HC = _RNA.CMD_PARSE_HC

_RNA.CMD_PARSE_SC_swigconstant(_RNA)
CMD_PARSE_SC = _RNA.CMD_PARSE_SC

_RNA.CMD_PARSE_SD_swigconstant(_RNA)
CMD_PARSE_SD = _RNA.CMD_PARSE_SD

_RNA.CMD_PARSE_UD_swigconstant(_RNA)
...
_RNA.FC_TYPE_SINGLE_swigconstant(_RNA)
FC_TYPE_SINGLE = _RNA.FC_TYPE_SINGLE

_RNA.FC_TYPE_COMPARATIVE_swigconstant(_RNA)
...
class fold_compound(object):
    ...
    def eval_structure_pt_verbose(self, pt: 'IntVector', file: 'FILE *') -> "int":
    ...
    def subopt(self, *args) -> "std::vector< subopt_solution,std::allocator< subopt_solution > >":
        return _RNA.fold_compound_subopt(self, *args)
