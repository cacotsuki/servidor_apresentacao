...
init_full_help_array(void)
{
  ...
  RNAeval_args_info_full_help[14] = RNAeval_args_info_detailed_help[18];
  RNAeval_args_info_full_help[15] = RNAeval_args_info_detailed_help[19];
  RNAeval_args_info_full_help[16] = RNAeval_args_info_detailed_help[21];
  RNAeval_args_info_full_help[17] = RNAeval_args_info_detailed_help[22];
  ...
  RNAeval_args_info_full_help[20] = RNAeval_args_info_detailed_help[27];
  RNAeval_args_info_full_help[21] = RNAeval_args_info_detailed_help[28];
  RNAeval_args_info_full_help[22] = RNAeval_args_info_detailed_help[30];
  RNAeval_args_info_full_help[23] = RNAeval_args_info_detailed_help[31];
  ...
  RNAeval_args_info_full_help[26] = 0; 
  
}

const char *RNAeval_args_info_full_help[27];
...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[10] = RNAeval_args_info_detailed_help[16];
  RNAeval_args_info_help[11] = RNAeval_args_info_detailed_help[17];
  ...
  RNAeval_args_info_help[15] = RNAeval_args_info_detailed_help[22];
  RNAeval_args_info_help[16] = RNAeval_args_info_detailed_help[26];
  RNAeval_args_info_help[17] = RNAeval_args_info_detailed_help[27];
  RNAeval_args_info_help[18] = RNAeval_args_info_detailed_help[28];
  RNAeval_args_info_help[19] = RNAeval_args_info_detailed_help[30];
  RNAeval_args_info_help[20] = RNAeval_args_info_detailed_help[31];
  RNAeval_args_info_help[21] = RNAeval_args_info_detailed_help[33];
  RNAeval_args_info_help[22] = RNAeval_args_info_detailed_help[35];
  RNAeval_args_info_help[23] = 0; 
  
}

const char *RNAeval_args_info_help[24];
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->id_digits_help = RNAeval_args_info_detailed_help[12] ;
  args_info->id_start_help = RNAeval_args_info_detailed_help[14] ;
  args_info->temp_help = RNAeval_args_info_detailed_help[17] ;
  args_info->noTetra_help = RNAeval_args_info_detailed_help[18] ;
  args_info->dangles_help = RNAeval_args_info_detailed_help[19] ;
  args_info->energyModel_help = RNAeval_args_info_detailed_help[21] ;
  args_info->paramFile_help = RNAeval_args_info_detailed_help[22] ;
  args_info->nsp_help = RNAeval_args_info_detailed_help[24] ;
  args_info->circ_help = RNAeval_args_info_detailed_help[26] ;
  args_info->gquad_help = RNAeval_args_info_detailed_help[27] ;
  args_info->logML_help = RNAeval_args_info_detailed_help[28] ;
  args_info->shape_help = RNAeval_args_info_detailed_help[30] ;
  args_info->shapeMethod_help = RNAeval_args_info_detailed_help[31] ;
  args_info->shapeConversion_help = RNAeval_args_info_detailed_help[33] ;
