 ...
 * Edit the original source file "utils.ts" instead.
 */
...
int main(void)
{
    Suite *s1 = suite_create("Utilities");
    TCase *tc1_1 = tcase_create("Sequence_Utils");
    TCase *tc1_2 = tcase_create("Model_Details");
    TCase *tc1_3 = tcase_create("Structure_Utils");
    SRunner *sr = srunner_create(s1);
    int nf;

    suite_add_tcase(s1, tc1_1);
    tcase_add_test(tc1_1, test_vrna_nucleotide_encode);
    tcase_add_test(tc1_1, test_vrna_nucleotide_decode);
    tcase_add_test(tc1_1, test_sequence_encoding);
    suite_add_tcase(s1, tc1_2);
    tcase_add_test(tc1_2, test_vrna_md_update);
    suite_add_tcase(s1, tc1_3);
    tcase_add_test(tc1_3, test_get_ptypes);
