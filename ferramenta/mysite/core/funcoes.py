...
def write_sequence(text_area):
    wrt = open('/home/ubuntu/ferramenta_final/cuda_sankoff/seqs/008.fasta', 'w')
...
def read_sequence():
    ...
    with open('/home/ubuntu/ferramenta_final/cuda_sankoff/seqs/008.fasta') as file:
        for line in file:
            line.split('\n')
...
def read_file():
   # subprocess.check_output(['dos2unix', 'write.fasta'], cwd='/home/livanski/Documents/danielsundfeld-hpc/seqs')
    ...
    ler = open('/home/ubuntu/ferramenta_final/cuda_sankoff/seqs/008.fasta','r')
    read = ler.readline()
    return read
